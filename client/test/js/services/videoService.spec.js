describe('videoService test', function() {
    ...
    it('should fetch video snapshot', function(done) {
    	...
    	videoServiceInstance.getVideo(function(err, data) {
    		assert.ifError(err);
    ...
    it('should pan video in the requested direction', function(done) {
    	var testDir = 'up';
    	$httpBackend.expectPUT(baseUrl + '/pan', {dir: testDir}).respond(200);
    	videoServiceInstance.pan(testDir, function(err, data) {
    		assert.ifError(err);
    		done();
    	});
    	$httpBackend.flush();
    ...
    it('should handle error on pan video', function(done) {
    	var testDir = 'up';
    	$httpBackend.expectPUT(baseUrl + '/pan', {dir: testDir}).respond(500);
    	videoServiceInstance.pan(testDir, function(err, data) {
    		assert(err);
    		done();
    	});
    ...
    it('should set infrared video mode', function(done) {
    	var testIr = 'on';
    	$httpBackend.expectPUT(baseUrl + '/ir', {ir: testIr}).respond(200);
    	videoServiceInstance.setIR(testIr, function(err, data) {
    		assert.ifError(err);
    		done();
    	});
    	$httpBackend.flush();
    ...
    it('should handle error when setting infrared mode', function(done) {
    	var testIr = 'on';
    	$httpBackend.expectPUT(baseUrl + '/ir', {ir: testIr}).respond(500);
    	videoServiceInstance.setIR(testIr, function(err, data) {
    		assert(err);
    		done();
    	});
    ...
    it('should make request to return to preset', function(done) {
    	var testPreset = 1;
    	$httpBackend.expectPUT(baseUrl + '/preset', {preset: testPreset}).respond(200);
    	videoServiceInstance.goToPreset(testPreset, function(err, data) {
    		assert.ifError(err);
    		done();
    	});
    	$httpBackend.flush();
    ...
    it('should handle error when reqeusting return to preset', function(done) {
    	var testPreset = 1;
    	$httpBackend.expectPUT(baseUrl + '/preset', {preset: testPreset}).respond(500);
    	videoServiceInstance.goToPreset(testPreset, function(err, data) {
    		assert(err);
    		done();
    	});
